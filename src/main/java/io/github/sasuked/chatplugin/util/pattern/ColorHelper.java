...
public class ColorHelper {
    ...
    private static final List<MessagePattern> MESSAGE_PATTERNS = Arrays.asList(new GradientMessagePattern(), new SolidMessagePattern(), new RainbowMessagePattern());


    @NotNull
    public static String process(@NotNull String string) {
        for (MessagePattern messagePattern : MESSAGE_PATTERNS) {
            string = messagePattern.process(string);
        }
